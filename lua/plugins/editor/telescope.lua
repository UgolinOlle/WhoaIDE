return {
    ...
    dependencies = {{
        ...
        name = "Telescope node modules"
    }, {
        "nvim-telescope/telescope-file-browser.nvim",
        name = "Telescope find files"
    }, {
        "chip/telescope-software-licenses.nvim",
        name = "Telescope software licenses"
    }, {
    ...
    }}, {";ii", "<CMD>Telescope nerdy<CR>", {
        noremap = true,
        silent = true,
        desc = "List and select all available icons"
    }}, {";s", "<CMD>Telescope symbols<CR>", {
        noremap = true,
        silent = true,
        desc = "List and select all available symbols"
    }}, {";n", "<CMD>Telescope notify<CR>", {
        noremap = true,
        silent = true,
        desc = "Display notifications"
    }}, {";nn", "<CMD>Telescope node_modules list<CR>", {
        noremap = true,
        silent = true,
        desc = "Node modules"
    }}}
